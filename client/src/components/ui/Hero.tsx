...
export function Hero() {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 text-center px-4 flex flex-col items-center justify-center gap-6">
        <motion.img
          src={heroLogo}
          alt="Dmitriy Gusev"
          initial={{ 
        ...
        <motion.p 
          className="font-mono text-sm md:text-base text-white/60 tracking-wider"
          initial={{ opacity: 0, y: 10 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ delay: 0.3, duration: 0.6 }}
        >
          Дизайн, email-рассылки, сайты
        </motion.p>
      </div>
